            ...
            <div style={{ height: '280px', background: 'var(--pill-bg)', borderRadius: '16px', border: '1px solid var(--border-color)', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              {isScreenSharing ? (
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ width: '80px', height: '80px', borderRadius: '50%', background: 'var(--primary-teal)', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px auto', fontSize: '1.8rem', fontWeight: 800 }}>
                    SJ
                  </div>
                  <h4 style={{ fontSize: '1.05rem', fontWeight: 700, margin: 0 }}>{activeTelehealthRoom.counselorName}</h4>
                  <span style={{ fontSize: '0.8rem', color: 'var(--safety-green)', display: 'inline-flex', alignItems: 'center', gap: '4px', marginTop: '4px' }}>
                    <IconlyVolume size={14} /> Speaking...
                  </span>
                </div>
              )}
