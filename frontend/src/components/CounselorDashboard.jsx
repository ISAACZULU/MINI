  ...
  return (
    <div className="counselor-dashboard-container">
      ...
      <div className="counselor-main-grid" style={{ gridTemplateColumns: activeSection === 'inbox' ? '1fr' : undefined }}>
        ...
        {/* Right Column: Booked Sessions (visible when activeSection is triage) */}
        {activeSection === 'triage' && (
          <div className="appointments-section">
            <div className="section-title-bar">
              <h3 className="section-heading">Confirmed Sessions ({appointments.length})</h3>
            </div>
            ...
            <div className="appointments-list">
              {appointments.length > 0 ? (
                  ...
                  <div key={appt.id} className="counselor-appt-card">
                    ...
                    <div style={{ display: 'flex', gap: '8px', marginTop: '12px' }}>
                      {appt.mode === 'Telehealth Video' ? (
                        ...
                        <div style={{ flex: 1, fontSize: '0.8rem', color: 'var(--text-muted)', display: 'flex', alignItems: 'center' }}>
                ...
                <p style={{ fontStyle: 'italic', color: 'var(--text-subtle)', fontSize: '0.9rem' }}>No upcoming sessions booked yet.</p>
              )}
            </div>
          </div>
        )}
